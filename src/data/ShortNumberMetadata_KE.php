...
return array (
  ...
  'shortCode' => 
  array (
    'NationalNumberPattern' => '1(?:0(?:[07-9]|1[12]|400)|1(?:[02456]|9[0-579])|2[123]|3[01]|5(?:01|1[01]|2[0-2457]|33|55|6(?:29|6[67]))|65\\d{2}|[78]\\d|9(?:[02-9]\\d{2}|19))|(?:2[0-79]|3[0-29]|4[0-4])\\d{3}|5(?:[0-2]\\d|99)\\d{2}|(?:6[2357]|7[0-29])\\d{3}|8(?:[0-9]\\d{3}|988)|9(?:09\\d{2}|99)',
    'ExampleNumber' => '116',
    'PossibleLength' => 
    array (
    ),
